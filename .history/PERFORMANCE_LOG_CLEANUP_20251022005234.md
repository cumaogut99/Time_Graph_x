...
### **2. Signal & Legend İşlemleri** (2 log)
...
### **3. Graph Settings İşlemleri** (4 log)
...
### **İstatistikler:**
- 🧹 **18 gereksiz INFO logu** DEBUG'a çevrildi
...
### **2. src/managers/legend_manager.py**
- ✅ `Added legend item` → DEBUG

### **3. src/managers/cursor_manager.py**
- ✅ 10 cursor log → DEBUG
