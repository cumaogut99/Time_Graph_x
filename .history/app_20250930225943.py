...
try:
    # REFACTORED VERSION - 74% daha az kod!
    from time_graph_widget_v2 import TimeGraphWidget  # Yeni refactored versiyon
    # from time_graph_widget import TimeGraphWidget  # Orijinal versiyon (yedek)
