...
class TimeGraphApp(QMainWindow):
    ...
    def _restore_widget_state(self, file_index: int):
        ...
        try:
            ...
            if widget_state and 'layout_config' in widget_state:
                ...
                logger.debug(f"No saved widget state for file index {file_index}")
