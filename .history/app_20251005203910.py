...
# REMOVED: Old DataLoader code (400+ lines) moved to src/data/data_loader.py
# All data loading logic including _load_data, _sanitize_dataframe, etc. is now in the dedicated module
