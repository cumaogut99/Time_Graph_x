...
class TimeGraphApp(QMainWindow):
    ...
    def _on_file_switched(self, new_index: int):
        ...
        old_index = self.file_manager.active_file_index
        ...
        try:
            ...
            logger.debug("Widget data update complete")
            ...
            # Widget state'i restore et (grafik ayarları, seçili sinyaller, vb.)
            self._restore_widget_state_for_file(new_index)
