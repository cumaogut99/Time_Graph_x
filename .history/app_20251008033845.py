    ...
    def _restore_widget_state_for_file(self, file_index: int):
        ...
        try:
            ...
            if widget_state:
                ...
                logger.info(f"Widget state restored for file {file_index}: {widget_state.get('tab_count', 0)} tabs")
            else:
                logger.debug(f"No saved widget state for file {file_index}, starting clean")
