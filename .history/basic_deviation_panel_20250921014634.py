...
class BasicDeviationPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.enable_fluctuation.setChecked(False)
        ...
        self.highlight_deviations.setChecked(False)
        ...
        self.red_highlighting.setChecked(False)
        ...
        self.show_bands.setChecked(False)
