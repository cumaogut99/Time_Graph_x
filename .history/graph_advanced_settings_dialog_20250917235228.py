...
# ParameterFiltersPanel moved to separate file: parameter_filters_panel.py
...
class GraphAdvancedSettingsDialog(QDialog):
    ...
    def _setup_ui(self):
        """Setup the advanced settings dialog UI with sidebar navigation."""
    ...
    def _create_sidebar(self, parent_layout):
        ...
        self.parameters_btn = self._create_nav_button("📊 Parameters", 0)
        self.filters_btn = self._create_nav_button("🔍 Range Filters", 1)
        self.limits_btn = self._create_nav_button("⚠️ Static Limits", 2)
        self.deviation_btn = self._create_nav_button("📈 Deviation", 3)
        
        sidebar_layout.addWidget(self.parameters_btn)
        sidebar_layout.addWidget(self.filters_btn)
        sidebar_layout.addWidget(self.limits_btn)
        sidebar_layout.addWidget(self.deviation_btn)
        sidebar_layout.addStretch()
        
        parent_layout.addWidget(sidebar)
        
    def _create_nav_button(self, text: str, button_id: int):
        ...
        """)
        self.nav_buttons.addButton(button, button_id)
        return button
    ...
    def _create_main_content(self, parent_layout):
        ...
        self.static_limits_panel = self._create_static_limits_panel()
        self.deviation_panel = self._create_deviation_panel()
    ...
    def _create_parameters_panel(self):
        """Create the parameters selection panel."""
        panel = QWidget()
    ...
    def _create_static_limits_panel(self):
        """Create the static limits panel."""
        panel = QWidget()
        layout = QVBoxLayout(panel)
        ...
        info_label = QLabel("Static limits configuration will be implemented here.")
        info_label.setStyleSheet("color: #e6f3ff; padding: 20px;")
        layout.addWidget(info_label)
        layout.addStretch()
        
        return panel
        
    def _create_deviation_panel(self):
        """Create the deviation analysis panel."""
        panel = QWidget()
        layout = QVBoxLayout(panel)
        ...
        info_label = QLabel("Deviation analysis tools will be implemented here.")
        info_label.setStyleSheet("color: #e6f3ff; padding: 20px;")
        layout.addWidget(info_label)
        layout.addStretch()
    ...
    def _create_bottom_buttons(self):
        ...
        # This will be added to the main layout later
        pass
    ...
    def _setup_connections(self):
        """Setup signal connections for the dialog."""
        # Navigation
