...
class GraphRenderer:
    ...
    def _highlight_limit_violations(self, plot_widget, graph_index: int, signal_name: str, limits: Dict[str, float]):
        ...
        try:
            ...
            violation_pen = pg.mkPen(color='#FF6B6B', width=3, style=pg.QtCore.Qt.DashLine)
    ...
    def _get_limits_configuration(self, graph_index: int) -> Dict[str, Any]:
        ...
        # This should be implemented to get limits from the parent widget
        # For now, return empty dict - will be connected later
        return {}
