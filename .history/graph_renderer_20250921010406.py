...
class GraphRenderer:
    ...
    def _apply_basic_deviation_to_graph(self, graph_index: int, deviation_settings: Dict[str, Any]):
        ...
        logger.info(f"[DEVIATION DEBUG] Starting deviation application for graph {graph_index}")
            ...
            if selected_parameters:
                ...
                for selected_parameter in selected_parameters:
                    if selected_parameter in all_signals_data:
                        ...
                        logger.info(f"[DEVIATION DEBUG] Calculating deviation for {selected_parameter}")
                        ...
                        # Visualize results
                        logger.info(f"[DEVIATION DEBUG] Visualizing results for {selected_parameter}")
