...
class GraphSettingsPanelManager(QObject):
    ...
    def _setup_settings_panel(self):
        ...
        # Create main container layout (no scroll area at this level)
        container_widget = QWidget()
        main_layout = QVBoxLayout(container_widget)
        main_layout.setContentsMargins(5, 5, 5, 5)
        main_layout.setSpacing(3)
        
        # The main_layout is where we will dynamically add graph control groups
        self.dynamic_controls_layout = main_layout
