...
class ParameterFiltersPanel(QWidget):
    ...
    def _reset_range_filters(self):
        ...
        reply = QMessageBox.question(self, 'Reset Filters', 
                                   f'Are you sure you want to reset all range filters for Graph {self.graph_index + 1}?',
    ...
    def _add_range_condition(self):
        ...
        param_label.setStyleSheet("color: #e6f3ff; font-weight: 600;")
        ...
        param_layout.addWidget(param_list)
        condition_layout.addLayout(param_layout)
        ...
        lower_enabled.setStyleSheet("color: #e6f3ff;")
        ...
        upper_enabled.setStyleSheet("color: #e6f3ff;")
