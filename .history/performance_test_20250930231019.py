...
print(f"   ✓ PyQt5 yüklendi: {import_time:.3f} saniye")
...
print(f"   ✓ QApplication oluşturuldu: {app_time:.3f} saniye")
...
print(f"   ✓ TimeGraphWidget import edildi: {widget_import_time:.3f} saniye")
...
print(f"   ✓ Widget başlatıldı: {widget_init_time:.3f} saniye")
...
print(f"   ✓ Widget gösterildi: {show_time:.3f} saniye")
...
try:
    ...
    if os.path.exists('test_data.csv'):
        ...
        print(f"   ✓ Test verisi okundu: {df.height} satır, {len(df.columns)} sütun")
        ...
        print(f"   ✓ Veri yüklendi ve işlendi: {data_update_time:.3f} saniye")
    else:
        print("   ⚠ test_data.csv bulunamadı, veri yükleme testi atlandı")
...
print("\n📈 DEĞERLENDİRME:")
if total_time < 3:
    print("  ✅ Mükemmel - Çok hızlı başlatma!")
elif total_time < 5:
    print("  ✅ İyi - Kabul edilebilir başlatma süresi")
elif total_time < 8:
    print("  ⚠️  Orta - İyileştirilebilir")
else:
