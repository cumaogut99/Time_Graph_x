...
class PlotManager(QObject):
    ...
    def _setup_context_menu(self, plot_widget):
        ...
        # Create a completely custom context menu
        custom_menu = QMenu()
        
        # Add cursor zoom action at the top level
        ...
        custom_menu.addAction(zoom_action)
        
        # Add separator
        custom_menu.addSeparator()
        
        # Add original plot options as a submenu
        plot_options_menu = custom_menu.addMenu("📊 Plot Options")
        
        # Get the original context menu actions and add them to the submenu
        original_menu = plot_widget.plotItem.ctrlMenu
        if original_menu:
            for action in original_menu.actions():
                if action.isSeparator():
                    plot_options_menu.addSeparator()
                else:
                    # Clone the action for the submenu
                    ...
                    plot_options_menu.addAction(new_action)
        
        # Replace the original context menu
        plot_widget.plotItem.ctrlMenu = custom_menu
        ...
        custom_menu.aboutToShow.connect(lambda: self._update_context_menu_state(plot_widget))
