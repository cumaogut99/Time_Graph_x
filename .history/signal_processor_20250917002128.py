...
class SignalProcessor(QObject):
    ...
    def calculate_statistics(self, signal_names: Optional[List[str]] = None, 
                           time_range: Optional[Tuple[float, float]] = None) -> Dict[str, Dict]:
        """
        ...
        with QMutexLocker(self.mutex):
            ...
            for name in signal_names:
                ...
                stats = self._calculate_signal_statistics(y_subset, x_subset)
                results[name] = stats
            
            return results
    
    def get_statistics(self, signal_name: str, time_range: Optional[Tuple[float, float]] = None) -> Optional[Dict[str, float]]:
        """
        ...
        """
        stats_dict = self.calculate_statistics([signal_name], time_range)
