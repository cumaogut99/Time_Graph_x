...
class GraphRenderer:
    ...
    def apply_segmented_filter(self, container, graph_index: int, time_segments: List[Tuple[float, float]], tab_index: int = 0):
        ...
        logger.info(f"[SEGMENTED DEBUG] Graph index: {graph_index}, Tab index: {tab_index}")
        ...
        logger.info(f"[SEGMENTED DEBUG] Target tab: {tab_index}")
    ...
    def _get_signal_color(self, signal_name: str) -> str:
        ...
        # Use theme manager colors if available
        if hasattr(self, 'theme_manager') and self.theme_manager:
            return self.theme_manager.get_signal_color(signal_index)
