    ...
    def _restore_signals(self, signal_data: Dict[str, Dict]):
        ...
        for name in signal_names:
            ...
            if name in signal_mapping:
                ...
                # CRITICAL FIX: Don't move signals to different graphs!
                # If plot_index is invalid (graph was removed), DON'T draw the signal
                # The signal will remain in graph_signal_mapping for future restore
                if plot_index >= self.subplot_count:
                    ...
                    continue  # Skip this signal, don't draw it
