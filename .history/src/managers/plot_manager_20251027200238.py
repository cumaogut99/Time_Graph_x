...
class PlotManager(QObject):
    ...
    def _restore_signals(self, signal_data: Dict[str, Dict]):
        ...
        signal_mapping = {}
        logger.info(f"[RESTORE] Checking parent for graph_signal_mapping: hasattr={hasattr(self.parent, 'graph_signal_mapping')}")
        ...
        if hasattr(self.parent, 'graph_signal_mapping'):
            ...
            if hasattr(self.parent, 'get_active_tab_index'):
                ...
                logger.warning("[RESTORE] Parent does not have get_active_tab_index method!")
            ...
            logger.error("[RESTORE] CRITICAL: Parent does not have graph_signal_mapping attribute!")
