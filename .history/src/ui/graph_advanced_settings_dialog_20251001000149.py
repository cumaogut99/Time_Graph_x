...
class GraphAdvancedSettingsDialog(QDialog):
    ...
    def _ensure_panel_loaded(self, panel_index: int):
        ...
        if panel_index == 1 and self.parameter_filters_panel is None:
            ...
            # Remove placeholder, insert new panel
            ...
            self.stacked_widget.insertWidget(4, self.advanced_deviation_panel)
            ...
            self.stacked_widget.insertWidget(5, self.advanced_filters_panel)
