...
class StatisticsPanel(QWidget):
    ...
    def _apply_theme_styling(self, theme_colors=None):
        ...
        if is_light_theme:
            ...
            title_bg_color = 'rgba(255, 255, 255, 0.8)'  # Light background for title
        else:
        ...
        for stat_name, value in stats.items():
            ...
            if stat_name in labels and (is_cursor_stat or stat_name in self.visible_stats):
                ...
                if label is not None:
                    ...
                    if is_cursor_stat:
                        # Use theme-appropriate styling for cursor values
                        label.setStyleSheet("")  # Will inherit from parent
