...
class TimeGraphWidget(QWidget):
    ...
    def update_data(self, df):
        ...
        all_signals = self.signal_processor.process_data(df, self.is_normalized)
    ...
    def _update_statistics(self, cursor_pos=None, selected_range=None):
        ...
        for graph_index, signal_names in tab_mapping.items():
            for signal_name in signal_names:
                ...
                stats = self.signal_processor.get_statistics(signal_name, stats_range)
                if stats:
    ...
    def _apply_segmented_filter(self, container, graph_index: int, time_segments: list):
        ...
        plot_widget = container.plot_manager.get_plot_widget(graph_index)
        if plot_widget:
            plot_widget.clear()
