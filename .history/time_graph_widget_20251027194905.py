...
class TimeGraphWidget(QWidget):
    ...
    def _on_graph_count_changed(self, count: int):
        ...
        if active_container:
            ...
            # ✅ FIX: Grafik sayısı değiştiğinde graph_signal_mapping'i güncelle
            ...
            logger.info(f"✅ Updated graph_signal_mapping for tab {current_tab}: {self.graph_signal_mapping[current_tab]}")
