...
class TimeGraphWidget(QWidget):
    ...
    def _on_cursor_moved(self, cursor_positions: Dict[str, float]):
        """Handle cursor movement with throttling for real-time updates."""
    ...
    def _perform_statistics_update(self):
        """Perform the actual statistics update (throttled)."""
        if self._pending_cursor_positions is None:
            return
        
        logger.debug(f"Performing throttled statistics update")
        
        # ✅ OPTIMIZED: Update timestamp for throttling
