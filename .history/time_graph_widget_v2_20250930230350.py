...
class TimeGraphWidget(QWidget):
    ...
    def _create_channel_statistics_panel(self):
        ...
        # Eğer zaten oluşturulmuşsa, mevcut olanı kullan
    ...
    def _add_tab(self):
        """Yeni tab ekle."""
        try:
            # GraphContainer'a doğru parametreleri gönder: theme_manager, main_widget
            container = GraphContainer(self.theme_manager, self, parent=self)
